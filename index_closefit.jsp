...
table.dataTable tr.odd { background-color: light-green; }
...
<div id="dbutton" style="background-color:white;border-bottom:solid 1px">
<p style="font-style:bold">Menu</p>
			<a id="addrow" title = "Insert New Row"><img src="images/add.jpg"></a>
			<a id="saverow" title = "Update/Save to DB"><img src="images/save.png"></a>
			<a id="refresh" title = "refresh page"><img src="images/refresh.jpg"></a>
		
	</div>
</div>
<p  id="data"></p>
   <div id="dtable">
		<table id="example" class="display hover" cellspacing="0"
			width="100%">
			<thead>
				<tr>
					<th>S.No</th>

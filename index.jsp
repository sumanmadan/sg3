...
.ui-datepicker-current-day .ui-state-active { background:light-green; }

.datehighlight {background:light-green; }
 ...
 $(document).ready(function() {
	...
	//Get datatable    
	 var posting = $.post("Gtable");
 	  posting.done(function(data) {
 		// $('#result').remove().children();
 		  ...
 		  //forcibly apply datepicker in the dateformat 
 		 $('.dp').each(function(){
 		           $(this).datepicker({
 		        	  changeMonth: true,
 		 		       changeYear: true,
 	 ...
 	 //Tick for update flag when row is clicked.

 	 /*	$("td").on('click', 'select option', function (e) {
 			var domElement = $( this ).get( 0 );
 	 		if ( domElement.nodeName === "TD") {
	 		         ...
	 		         table.find('tr').each(function (i) {
	 		        	 if ( i == row_index) {
	 		        		...
	 		        		// $(this).find("input[type=checkbox]").attr("checked", true);
	 		                 ...
	 		                 clickedCellVal = $tds.eq(col_index).text();
	 		                //alert('Row ' + (i + 1) + ':\nId: ' + clickedCellVal );
     ...
     //Add button functionality. Works wil no trouble. 		
    	 ...
    	 var flag = chk.prop('checked');
            ...
            // urgency =  $tds.eq(5).val();
             ...
             if ( required_B == "B:true") {
            	  // alert( ddd + "lllllllllll" + ddd.length);
            	 
            	 if ((ddd == undefined) || (ddd == null) || ddd == "null"  || ddd.length < 5 ) {
